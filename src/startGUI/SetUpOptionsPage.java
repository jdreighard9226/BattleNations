...
public class SetUpOptionsPage {
    ...
    public SetUpOptionsPage() {
        ...
        // Sets game setup data based on slected troop placement option.
        randomTroops.addActionListener(e -> startController.getGameSetUpData().setRandomTroopPlacement(true));
        manualTroops.addActionListener(e -> startController.getGameSetUpData().setRandomTroopPlacement(false));
