...
public class MapDisplay {
    ...
    /** Service used to load territory and region data from a map file. */
    private final MapLoaderService loader;

    /** Data object returned by the map loader containing territories and regions. */
    private final MapLoaderData mapData;

    /** The list of regions parsed from the map file. */
     ...
     *
     * @param setUpData       the setup data containing the map file path
     * @param setUpController the controller used to manage GUI navigation
     */
    ...
    /**
     * Adds the map display panel to the given JFrame.
     *
     * @param parent the JFrame to add the map display to
     */
    ...
    /**
     * Removes the map display panel from the given Frame.
     *
     * @param parent the Frame to remove the map display from
     */
    ...
    /**
     * Returns the 2D array of territories representing the map grid.
     *
    ...
    /**
     * Returns the list of regions parsed from the map file.
     *
    ...
    /**
     * Returns the map panel used to render the map.
     *
     * @return the map display panel
     */
