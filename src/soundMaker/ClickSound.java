...
/**
 * Handles click sound effects for the Battle Nations application.
 *
 * <p>
...
public class ClickSound {
    ...
    /** First audio clip used for click sound playback. */
    private Clip clickSound1;

    /** Second audio clip used to allow rapid back-to-back click sounds. */
    ...
    private final boolean useFirst = true;

    /**
     * Constructs a ClickSound object and attempts to load the specified sound file.
     *
     * <p>
     ...
     */
    public ClickSound(String fileName) {
    ...
    /**
     * Plays the click sound effect starting from a specified frame position.
     *
     * <p>
    ...
    public void playSound(int frameStart) {
        if (soundWorking) {
            if (useFirst) {
                clickSound1.stop();
                clickSound1.setFramePosition(frameStart);
                clickSound1.start();
            } else {
                clickSound2.stop();
                clickSound2.setFramePosition(frameStart);
                clickSound2.start();
            }
        }
    }
    ...
    public void setVolume(float volume) {
        ...
        FloatControl volumeControl1 = (FloatControl) clickSound1.getControl(FloatControl.Type.MASTER_GAIN);
        FloatControl volumeControl2 = (FloatControl) clickSound2.getControl(FloatControl.Type.MASTER_GAIN);
        this.volume = volume;
